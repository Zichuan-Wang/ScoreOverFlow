...
public class SearchRoomConstraintTest {
	...
	public void createAndChangeSearchConstraint() {
		...
		constraint.setCapacity(DEFAULT_CAPACITY).setStartTime(DEFAULT_START_TIME).setEndTime(DEFAULT_END_TIME)
				.setRoomName(DEFAULT_ROOM_NAME).setEventDate(DEFAULT_EVENT_DATE);
